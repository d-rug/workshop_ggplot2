...
Layers are the building blocks of the grammar of graphics. There aren't even that many of them! Here is the list, and the name of the function(s) you'll use to control the layer.
